...
class KittiDB:
    ...
    def box_to_string(name: str,
        ...
        # print(f"v {v}")
        v2 = box.rotation_matrix
        # print(f"v2 {v2}")
        yaw = -np.arctan2(v[2], v[0])
        orientation_quaternion2 = Quaternion(box.orientation)
        yaw_angle_radians2 = orientation_quaternion2.yaw_pitch_roll[0]
        # print(f"yaw2 {yaw_angle_radians2}")
        # Prepare output.
        name += ' '
